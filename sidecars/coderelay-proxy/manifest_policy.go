...
const (
	clientAPIKeyContextKey     contextKey = "coderelayClientAPIKey"
	requestKindContextKey      contextKey = "coderelayRequestKind"
	requestModelContextKey     contextKey = "coderelayRequestModel"
	clientInstanceIDContextKey contextKey = "coderelayClientInstanceId"
	clientInstanceIDHeaderName            = "X-CodeRelay-Instance-Id"
)
...
const coderelayQuotaPath = "/v1/coderelay/quota"
...
func buildOllamaTag(model string, modifiedAt time.Time) gin.H {
	...
	return gin.H{
		...
		"details": gin.H{
			"parent_model":       "",
			"format":             "coderelay-codex-api-service",
			"family":             family,
...
func buildOllamaShowResponse(model string, modifiedAt time.Time) gin.H {
	...
	return gin.H{
		"model":        model,
		"remote_model": model,
		"license":      "Proxied via CodeRelay Codex API Service",
